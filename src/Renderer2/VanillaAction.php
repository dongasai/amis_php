...
/**
 * The VanillaAction class.
 *
 * @method actionType(string $v)  
 * @method downloadFileName(string $v)  
 ...
 */
class VanillaAction extends BaseSchema
{
    protected string $type = 'vanillaaction';
}
