 ...
 * @method validationErrors(\AmisPhp\Renderer2\Condition\Builder\ValidationErrors$v) 验证失败的提示信息 
 ...
 * @method formula(\AmisPhp\Renderer2\Condition\Builder\Formula$v) 将字段输入控件变成公式编辑器。 
