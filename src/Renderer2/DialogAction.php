...
/**
 * The DialogAction class.
 *
 * @method actionType(string $v) 指定为打开弹窗 
 * @method dialog( $v) 弹框详情 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/dialog 
 ...
 */
class DialogAction extends BaseSchema
{
    protected string $type = 'dialogaction';
}
