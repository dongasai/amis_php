 ...
 * @method messages(\AmisPhp\Renderer2\Input\Array\InputArrayMessages$v) 提示信息 
 ...
 * @method validationErrors(\AmisPhp\Renderer2\Input\Array\InputArrayValidationErrors$v) 验证失败的提示信息 
 ...
 */
class InputArray extends BaseSchema
{
