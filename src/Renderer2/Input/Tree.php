 ...
 * @method validationErrors(\AmisPhp\Renderer2\Input\Tree\ValidationErrors$v) 验证失败的提示信息 
 ...
 * @method searchConfig(\AmisPhp\Renderer2\Input\Tree\SearchConfig$v) 搜索框的配置 
 * @method heightAuto(boolean$v) 高度自动增长？ 

 */
class Tree extends BaseSchema
{
