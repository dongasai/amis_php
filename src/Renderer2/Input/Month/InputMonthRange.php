<?php
namespace AmisPhp\Renderer2\Input\Month;
 ...
 * @method validationErrors(\AmisPhp\Renderer2\Input\Month\Range\InputMonthRangeValidationErrors$v) 验证失败的提示信息 
 ...
 */
class InputMonthRange extends BaseSchema
{
