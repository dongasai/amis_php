 ...
 * @method validationErrors(\AmisPhp\Renderer2\Input\Group\ValidationErrors$v) 验证失败的提示信息 
 ...
 * @method validationConfig(\AmisPhp\Renderer2\Input\Group\ValidationConfig$v) 校验提示信息配置 
