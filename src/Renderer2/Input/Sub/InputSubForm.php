 ...
 * @method validationErrors(\AmisPhp\Renderer2\Input\Sub\Form\InputSubFormValidationErrors$v) 验证失败的提示信息 
 ...
 * @method form(\AmisPhp\Renderer2\Input\Sub\Form\InputSubFormForm$v) 子表单详情 
 * @method scaffold($v)  
