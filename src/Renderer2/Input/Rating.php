 ...
 * @method validationErrors(\AmisPhp\Renderer2\Input\Rating\ValidationErrors$v) 验证失败的提示信息 
 ...
 * @method texts(\AmisPhp\Renderer2\Input\Rating\Texts$v) 星星被选中时的提示文字 
 ...
 */
class Rating extends BaseSchema
{
