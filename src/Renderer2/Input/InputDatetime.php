 ...
 * @method validationErrors(\AmisPhp\Renderer2\Input\Datetime\InputDatetimeValidationErrors$v) 验证失败的提示信息 
 ...
 * @method timeFormat(string$v) 时间的格式。 
 * @method minDate(string$v) 限制最小日期 
 * @method maxDate(string$v) 限制最大日期 
 * @method timeConstraints($v) 时间输入范围限制 
 * @method isEndDate(boolean$v) 是否为结束时间，如果是，那么会自动加上 23:59:59 

 */
class InputDatetime extends BaseSchema
{
