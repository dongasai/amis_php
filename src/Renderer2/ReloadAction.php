...
/**
 * The ReloadAction class.
 *
 * @method actionType(string $v) 指定为刷新目标组件。 
 * @method target( $v) 指定目标组件。 
 ...
 */
class ReloadAction extends BaseSchema
{
    protected string $type = 'reloadaction';
}
