<?php
namespace AmisPhp\Renderer2\Tabs;
 ...
 * @method pagination(\AmisPhp\Renderer2\Tabs\Transfer\TabsTransferPagination$v) 分页配置，selectMode为默认和table才会生效 
 ...
 * @method validationErrors(\AmisPhp\Renderer2\Tabs\Transfer\TabsTransferValidationErrors$v) 验证失败的提示信息 
 ...
 */
class TabsTransfer extends BaseSchema
{
