<?php
namespace AmisPhp\Renderer2\Tabs\Transfer;
 ...
 * @method pagination(\AmisPhp\Renderer2\Tabs\Transfer\Picker\TabsTransferPickerPagination$v) 分页配置，selectMode为默认和table才会生效 
 ...
 * @method validationErrors(\AmisPhp\Renderer2\Tabs\Transfer\Picker\TabsTransferPickerValidationErrors$v) 验证失败的提示信息 
 ...
 */
class TabsTransferPicker extends BaseSchema
{
