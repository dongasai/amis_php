...
/**
 * The DrawerAction class.
 *
 * @method actionType(string $v) 指定为打开弹窗，抽出式弹窗 
 * @method drawer( $v) 抽出式弹框详情 文档：https://aisuda.bce.baidu.com/amis/zh-CN/components/drawer 
 * @method nextCondition( $v) 是否有下一个的表达式，正常可以不用配置，如果想要刷掉某些数据可以配置这个。 
 * @method reload( $v)  
 ...
 */
class DrawerAction extends BaseSchema
{
    protected string $type = 'draweraction';
}
