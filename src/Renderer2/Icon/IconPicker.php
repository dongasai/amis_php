<?php
namespace AmisPhp\Renderer2\Icon;
 ...
 * @method validationErrors(\AmisPhp\Renderer2\Icon\Picker\IconPickerValidationErrors$v) 验证失败的提示信息 
 ...
 */
class IconPicker extends BaseSchema
{
