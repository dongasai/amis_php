 ...
 * @method validationErrors(\AmisPhp\Renderer2\Nested\Select\ValidationErrors$v) 验证失败的提示信息 
 ...
 * @method overflowTagPopover(\AmisPhp\Renderer2\Nested\Select\OverflowTagPopover$v) 收纳标签的Popover配置 

 */
class Select extends BaseSchema
{
