 ...
 * @method data(\AmisPhp\Renderer2\DrawerSchemaBase\DrawerSchemaBaseData $v) 数据映射 

 */
class DrawerSchemaBase extends BaseSchema
{
    protected string $type = 'drawerschemabase';
}
