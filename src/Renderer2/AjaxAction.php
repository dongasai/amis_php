...
/**
 * The AjaxAction class.
 *
 * @method actionType(string $v) 指定为发送 ajax 的行为。 
 * @method api( $v) 配置 ajax 发送地址 
 * @method feedback( $v)  
 * @method reload( $v)  
 * @method redirect(string $v)  
 * @method ignoreConfirm(boolean $v)  
 * @method isolateScope(boolean $v) 是否开启请求隔离, 主要用于隔离联动CRUD, Service的请求 
 ...
 */
class AjaxAction extends BaseSchema
{
    protected string $type = 'ajaxaction';
}
