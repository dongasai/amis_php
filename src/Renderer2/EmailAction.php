...
/**
 * The EmailAction class.
 *
 * @method actionType(string $v) 指定为打开邮箱行为 
 * @method to(string $v) 收件人邮箱 
 * @method cc(string $v) 抄送邮箱 
 * @method bcc(string $v) 匿名抄送邮箱 
 * @method subject(string $v) 邮件主题 
 * @method body(string $v) 邮件正文 
 ...
 */
class EmailAction extends BaseSchema
{
    protected string $type = 'emailaction';
}
