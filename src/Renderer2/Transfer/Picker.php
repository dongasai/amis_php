 ...
 * @method pagination(\AmisPhp\Renderer2\Transfer\Picker\Pagination$v) 分页配置，selectMode为默认和table才会生效 
 ...
 * @method validationErrors(\AmisPhp\Renderer2\Transfer\Picker\ValidationErrors$v) 验证失败的提示信息 
