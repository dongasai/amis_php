<?php
namespace AmisPhp\Renderer2\Transfer;
 ...
 * @method pagination(\AmisPhp\Renderer2\Transfer\Picker\TransferPickerPagination$v) 分页配置，selectMode为默认和table才会生效 
 ...
 * @method validationErrors(\AmisPhp\Renderer2\Transfer\Picker\TransferPickerValidationErrors$v) 验证失败的提示信息 
 ...
 * @method pickerSize(string$v) 弹窗大小 

 */
class TransferPicker extends BaseSchema
{
